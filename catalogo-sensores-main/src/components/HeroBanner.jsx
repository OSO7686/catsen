    ...
    <section className="relative overflow-hidden h-[450px] bg-black">
      <div className={`absolute inset-0 transition-opacity duration-1000 flex items-center ${heroActive === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
        ...
        <div className="container mx-auto px-4 relative text-white">
          <span className="bg-blue-600 text-xs px-3 py-1 rounded-full font-bold mb-4 inline-block">NEW SEASON</span>
          <h2 className="text-5xl font-black mb-4 uppercase italic">Sensors SpO2<br /><span className="text-blue-400">Medical Grade</span></h2>
          <p className="text-lg mb-8 max-w-lg">High precision and durability guaranteed for intensive clinical use.</p>
      ...
      <div className={`absolute inset-0 transition-opacity duration-1000 flex items-center ${heroActive === 1 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
        ...
        <div className="container mx-auto px-4 relative text-white text-right ml-auto">
          ...
          <h2 className="text-5xl font-black mb-4 uppercase italic">Discounts on<br /><span className="text-green-400">ECG Cables</span></h2>
          <p className="text-lg mb-8 max-w-lg ml-auto">Special prices for hospitals and clinics on bulk purchases.</p>
          <a href="#" className="bg-green-500 text-white px-10 py-4 rounded font-black hover:bg-green-600 transition-all uppercase tracking-widest">View Offers</a>
        </div>
      </div>
    </section>
  );
